...
limitador_textarea('textarea_blog', 1800, 50);
limitador_textarea('textarea_parrafo_1', 900, 30);
limitador_textarea('textarea_parrafo_2', 900, 30);
limitador_textarea('textarea_parrafo_3', 900, 30);
limitador_textarea('textarea_parrafo_4', 900, 30);
