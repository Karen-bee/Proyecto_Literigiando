            ...
            <div class = "formulario">
                ...
                <p>Se enviara un correo para realizar el cambio <br> de contraseña.</p>
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="exampleInputPassword1" placeholder = "Ingrese el correo electronico">
                        <a class = "enlace1" href="#">Volver a inicio de sesión</a>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn3">Enviar Correo</button>
                    </div>
